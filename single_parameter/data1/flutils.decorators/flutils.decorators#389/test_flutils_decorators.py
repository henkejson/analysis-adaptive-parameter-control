...
def test_case_0():
    bytes_0 = b"\xfd\xed\xf6v\xech"
    cached_property_0 = module_0.cached_property(bytes_0)
    none_type_0 = None
    var_0 = cached_property_0.__get__(none_type_0, none_type_0)
    var_1 = cached_property_0.__get__(none_type_0, cached_property_0)
    cached_property_0.__get__(bytes_0, var_1)


def test_case_1():
    bytes_0 = b"\xfd\xed\xf6v\xec\xd9h"
    cached_property_0 = module_0.cached_property(bytes_0)
