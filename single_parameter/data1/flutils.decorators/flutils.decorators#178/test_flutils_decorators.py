...
def test_case_0():
    ...
    var_2 = cached_property_2.__get__(none_type_0, none_type_0)
    cached_property_3 = module_0.cached_property(none_type_0)
    cached_property_1.__get__(cached_property_3, none_type_0)
