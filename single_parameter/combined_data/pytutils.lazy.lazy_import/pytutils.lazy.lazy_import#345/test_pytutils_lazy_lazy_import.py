...
def test_case_9():
    str_0 = "Ceate aproxy object which ill compile the regex on demand.\n\n    :retur: aLazyRegex proxy object.\n    "
    illegal_use_of_scope_replacer_0 = module_0.IllegalUseOfScopeReplacer(str_0, str_0)
...
def test_case_10():
    ...
    module_0.ImportReplacer(var_2, var_2, var_1, var_1, var_1)
