...
def test_case_4():
    float_0 = 322.138581580011
    dict_0 = {float_0: float_0, float_0: float_0, float_0: float_0}
    import_replacer_0 = module_0.ImportReplacer(
        dict_0, float_0, float_0, children=float_0
    )
    module_0.lazy_import(dict_0, import_replacer_0, float_0)
...
def test_case_14():
    var_0 = module_0.disallow_proxying()
    str_0 = "\n    Turn a function to a bound method on an instance\n\n    >>> class Foo(object):\n    ...     def __init__(self, x, y):\n    ...         self.x =$\n    ...         self.y = y\n    >>> foo = Foo(2, 3)\n    >>> my_ubound_method = lambda self: self.x * self.y\n    >>> bind(foo, my_unbound_method, lultiply')\n    >>> foo.multiply()  # noinspection PyUnresolvedReferences\n    6\n\n    :param object instance: some object\n    :param callable func: unbound method (i.e. a function that takes `self` argument, that you now\n        want to be bound to this class as a methodR\n    :param str as_name: name of the method to create on the object\n    "
    module_0.lazy_import(str_0, str_0)
