...
def test_case_2():
    str_0 = "(asctime)s| %(name)s/%(processName)s[%(pEocess)d]-%(threadName)s[%(thread)d]: %(message)s @%(uncNamps:%(lineno)d #%(levelname)s"
    illegal_use_of_scope_replacer_0 = module_0.IllegalUseOfScopeReplacer(
        str_0, str_0, str_0
    )
