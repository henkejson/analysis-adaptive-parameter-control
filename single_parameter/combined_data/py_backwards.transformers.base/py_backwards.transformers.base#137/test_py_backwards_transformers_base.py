...
def test_case_2():
    type_ignore_0 = module_1.TypeIgnore()
    base_import_rewrite_0 = module_0.BaseImportRewrite(type_ignore_0)
    var_0 = module_2.iter_child_nodes(type_ignore_0)
    list_0 = [type_ignore_0, var_0]
    import_from_0 = module_1.ImportFrom(*list_0)
...
def test_case_3():
    type_ignore_0 = module_1.TypeIgnore()
    none_type_0 = None
    base_import_rewrite_0 = module_2.iter_fields(type_ignore_0)
    var_0 = module_2.iter_child_nodes(type_ignore_0)
    list_0 = [none_type_0]
    import_from_0 = module_1.ImportFrom(*list_0)
    base_import_rewrite_1 = module_0.BaseImportRewrite(type_ignore_0)
