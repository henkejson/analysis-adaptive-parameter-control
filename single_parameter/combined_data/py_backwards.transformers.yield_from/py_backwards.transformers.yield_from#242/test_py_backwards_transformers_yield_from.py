...
def test_case_3():
    bit_xor_0 = module_2.BitXor()
    yield_from_transformer_0 = module_0.YieldFromTransformer(bit_xor_0)
    yield_from_transformer_1 = module_0.YieldFromTransformer(yield_from_transformer_0)
    list_0 = [yield_from_transformer_0, bit_xor_0, yield_from_transformer_0]
    dict_0 = {}
    if_exp_0 = module_2.IfExp(*list_0, **dict_0)
    a_s_t_0 = yield_from_transformer_1.visit(if_exp_0)
