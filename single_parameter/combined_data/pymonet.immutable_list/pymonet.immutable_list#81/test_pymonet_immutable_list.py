...
def test_case_8():
    ...
    var_0 = immutable_list_0.to_list()
    immutable_list_1 = var_0.append(none_type_0)
    bool_0 = False
    ...
    var_2 = immutable_list_2.find(bool_0)
...
def test_case_23():
    ...
    immutable_list_5 = immutable_list_2.append(var_0)
    immutable_list_6 = module_0.ImmutableList(is_empty=bool_0)
    immutable_list_5.find(var_1)
