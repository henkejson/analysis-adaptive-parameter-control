...
def test_case_3():
    complex_0 = -184.96505 + 4465.0326j
    immutable_list_0 = module_0.ImmutableList()
...
def test_case_19():
    ...
    bool_2 = immutable_list_1.__eq__(var_3)
    var_4 = var_2.__len__()
    var_5 = immutable_list_1.find(bool_2)
    immutable_list_3 = var_3.unshift(bool_0)
