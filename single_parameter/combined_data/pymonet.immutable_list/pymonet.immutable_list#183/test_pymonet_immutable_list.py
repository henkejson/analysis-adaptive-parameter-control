...
def test_case_8():
    bytes_0 = b"\x8f'\xa5 \xf1"
    bool_0 = False
    immutable_list_0 = module_0.ImmutableList(is_empty=bool_0)
    var_0 = immutable_list_0.__len__()
    bool_1 = False
    immutable_list_1 = immutable_list_0.unshift(immutable_list_0)
    immutable_list_2 = module_0.ImmutableList(tail=bytes_0, is_empty=bool_1)
    var_1 = immutable_list_2.__len__()
    var_2 = immutable_list_2.reduce(var_0, immutable_list_1)
    str_0 = var_2.__str__()
...
def test_case_10():
    bool_0 = True
    bytes_0 = b")\x83\x87\xa3\x89\xf1\xd3\x89"
