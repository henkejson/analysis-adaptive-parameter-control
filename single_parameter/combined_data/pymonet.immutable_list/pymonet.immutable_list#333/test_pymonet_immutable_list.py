...
def test_case_7():
    int_0 = -1221
    none_type_0 = None
    immutable_list_0 = module_0.ImmutableList(tail=int_0, is_empty=none_type_0)
...
def test_case_22():
    ...
    immutable_list_2 = module_0.ImmutableList(tail=tuple_0, is_empty=tuple_0)
    immutable_list_3 = immutable_list_2.unshift(tuple_0)
    immutable_list_3.reduce(none_type_0, immutable_list_3)
