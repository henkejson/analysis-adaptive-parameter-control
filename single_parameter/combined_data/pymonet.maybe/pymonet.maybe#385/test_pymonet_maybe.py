...
def test_case_7():
    ...
    maybe_2 = module_0.Maybe(none_type_2, bool_0)
...
def test_case_22():
    ...
    bool_4 = False
    var_6 = var_5.map(maybe_0)
    bool_5 = True
    maybe_2 = module_0.Maybe(bool_4, bool_5)
    var_5.get_or_else(maybe_1)
