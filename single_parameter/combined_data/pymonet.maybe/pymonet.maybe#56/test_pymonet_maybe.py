...
def test_case_7():
    bool_0 = True
    bytes_0 = b"1\x9d:4\x96\xe2\xe6\x85\x0b\x91c"
    bool_1 = True
...
def test_case_20():
    ...
    var_8 = maybe_1.ap(maybe_1)
    var_9 = var_1.bind(var_3)
    var_10 = maybe_1.to_box()
    var_11 = maybe_1.map(maybe_0)
    var_12 = var_8.to_either()
    var_13 = var_3.filter(var_12)
    var_14 = maybe_1.to_lazy()
    var_15 = var_2.ap(var_0)
...
def test_case_21():
    ...
    maybe_1 = module_0.Maybe(none_type_0, list_1)
    var_0 = maybe_0.to_either()
