...
def test_case_5():
    ...
    dict_0 = {none_type_2: none_type_2, none_type_3: none_type_0, var_0: str_0}
...
def test_case_11():
    ...
    bool_0 = False
    str_1 = "5C9XsRC$+FWg"
    module_0.Config(env_prefix=list_0, keep_alive=bool_0, converters=str_1)
