...
def test_case_1():
    sub_0 = module_1.Sub()
    yield_from_transformer_0 = module_0.YieldFromTransformer(sub_0)
...
def test_case_3():
    ...
    yield_from_transformer_0 = module_0.YieldFromTransformer(param_0)
    list_0 = [
