...
def test_case_3():
    str_0 = "uro5\\"
    var_0 = module_2.FunctionDef(*str_0)
    yield_from_transformer_0 = module_0.YieldFromTransformer(str_0)
    a_s_t_0 = yield_from_transformer_0.visit(var_0)
    yield_from_transformer_1 = module_0.YieldFromTransformer(a_s_t_0)
    yield_from_transformer_2 = module_0.YieldFromTransformer(var_0)
    module_1.copy_location(var_0, yield_from_transformer_0)
