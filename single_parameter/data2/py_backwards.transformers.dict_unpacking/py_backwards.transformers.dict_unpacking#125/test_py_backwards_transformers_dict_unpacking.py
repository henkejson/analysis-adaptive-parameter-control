...
def test_case_1():
    ...
    eq_0 = module_1.Eq()
    dict_unpacking_transformer_1 = module_0.DictUnpackingTransformer(eq_0)
    dict_unpacking_transformer_2 = module_0.DictUnpackingTransformer(eq_0)
    dict_unpacking_transformer_2.visit_Module(none_type_0)
