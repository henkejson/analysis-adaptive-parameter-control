...
def test_case_2():
    bytes_0 = b"k\xbd\xd5\xd4\x9b'\xaa\xe3&\x9a\xa1\xf31\x85\xd3\xc1\x85R\xe2|"
    illegal_use_of_scope_replacer_0 = module_0.IllegalUseOfScopeReplacer(
        bytes_0, bytes_0
    )
...
def test_case_10():
    ...
    str_0 = ""
    float_0 = 1922.0
    module_0.ImportReplacer(var_0, str_0, var_0, float_0, float_0)
