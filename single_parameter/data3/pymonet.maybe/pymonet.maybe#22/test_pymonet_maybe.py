...
def test_case_0():
    bytes_0 = b"\xeb\x8a[\xcb\xcc\xbd\xb8"
...
def test_case_4():
    ...
    var_7 = var_4.map(bytes_0)
    var_8 = var_5.map(var_4)
    var_9 = var_7.bind(int_0)
...
def test_case_16():
    ...
    bool_4 = var_4.__eq__(var_3)
    var_6 = var_3.to_box()
    var_7 = var_2.ap(maybe_1)
...
def test_case_19():
    ...
    maybe_0 = module_0.Maybe(bool_0, bool_0)
    var_0 = maybe_0.filter(maybe_0)
    bytes_0 = b"\x8c\x95\x08\xb5\x82\xf8\x03?\x80\x9d\x14\x91\xefJ#Kp\x81\xdcy"
...
def test_case_20():
    tuple_0 = ()
    int_0 = -1416
    maybe_0 = module_0.Maybe(int_0, tuple_0)
    none_type_0 = None
