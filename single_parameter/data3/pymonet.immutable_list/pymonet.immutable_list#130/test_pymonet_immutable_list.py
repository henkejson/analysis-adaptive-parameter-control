...
def test_case_9():
    ...
    list_0 = [immutable_list_2, var_1, dict_0]
    var_3 = immutable_list_2.reduce(var_2, list_0)
...
def test_case_13():
    immutable_list_0 = module_0.ImmutableList()
    immutable_list_1 = immutable_list_0.unshift(immutable_list_0)
    immutable_list_2 = immutable_list_0.reduce(immutable_list_0, immutable_list_1)
    immutable_list_1.find(immutable_list_1)
...
def test_case_14():
    ...
    immutable_list_2.reduce(immutable_list_0, var_0)
...
def test_case_20():
    ...
    immutable_list_0.reduce(var_2, str_0)
