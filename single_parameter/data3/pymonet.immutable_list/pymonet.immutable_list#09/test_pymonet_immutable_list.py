...
def test_case_13():
    ...
    str_0 = immutable_list_1.__str__()
    immutable_list_3 = module_0.ImmutableList(is_empty=immutable_list_2)
...
def test_case_18():
    tuple_0 = ()
    set_0 = {tuple_0}
    tuple_1 = (tuple_0, tuple_0, tuple_0, set_0)
    immutable_list_0 = module_0.ImmutableList(tuple_0, is_empty=tuple_1)
