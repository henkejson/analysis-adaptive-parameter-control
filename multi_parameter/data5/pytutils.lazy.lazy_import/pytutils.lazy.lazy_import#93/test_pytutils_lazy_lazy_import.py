...
def test_case_1():
    bytes_0 = b"5\x0e\x87\xbco\x9dE\xf3\xccY{U\x03T\x91\x19\xd7O"
    illegal_use_of_scope_replacer_0 = module_0.IllegalUseOfScopeReplacer(
        bytes_0, bytes_0
    )
...
def test_case_2():
    ...
    import_replacer_0 = module_0.ImportReplacer(
        dict_0, base_exception_0, none_type_0, dict_0
    )
    import_replacer_0.__getattribute__(base_exception_0)
