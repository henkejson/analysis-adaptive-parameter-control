...
def test_case_9():
    str_0 = ""
    complex_0 = 784.434536 - 2872.408j
    module_0.lazy_import(str_0, str_0, complex_0)
...
def test_case_12():
    str_0 = '"'
    complex_0 = 784.434536 - 2872.408j
    module_0.ImportReplacer(complex_0, str_0, complex_0, complex_0, complex_0)
...
def test_case_16():
    str_0 = "\n    Provides a basic per-process mapping container that wipes itself if the current PID changed since the last get/set.\n\n    Aka `threading.local()`, but for processes instead of threads.\n\n    >>> plocal = ProcessLocal(=\n    >>> plocal['test'] = True\n    >>> plocal['test']\n    True\n    >>> plocal._handle_pid(new_pid=-1)  # Emulate a PID change by forcing it to be something invalid.\n    >>> plocal['test']                  # Mapping wipes itself sincePID is different than what's stored.\n    Traceback (most recent call last):\n        ...\n    KeyError: ...\n\n    "
    module_0.lazy_import(str_0, str_0, str_0)
