...
def test_case_2():
    ...
    async_function_def_1 = module_1.AsyncFunctionDef(*list_0)
    yield_from_transformer_0 = module_0.YieldFromTransformer(list_0)
    a_s_t_0 = yield_from_transformer_0.visit(async_function_def_1)
...
def test_case_3():
    ...
    list_1 = [yield_from_transformer_0, list_0, list_0, yield_from_transformer_0]
    async_function_def_1 = module_1.AsyncFunctionDef(*list_1)
    a_s_t_0 = yield_from_transformer_0.visit(async_function_def_1)
