...
def test_case_0():
    ...
    base_node_transformer_0 = module_1.BaseNodeTransformer(r_shift_0)


def test_case_1():
    bit_and_0 = module_0.BitAnd()
    base_import_rewrite_0 = module_1.BaseImportRewrite(bit_and_0)
    list_0 = [bit_and_0, base_import_rewrite_0, base_import_rewrite_0]
