...
def test_case_3():
    ...
    eq_0 = module_1.Eq()
    return_from_generator_transformer_0 = module_0.ReturnFromGeneratorTransformer(eq_0)
    ...
    return_from_generator_transformer_1.visit_FunctionDef(list_0)
