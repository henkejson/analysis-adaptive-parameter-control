...
def test_case_18():
    ...
    var_1 = immutable_list_2.reduce(none_type_1, none_type_1)
    var_1.reduce(immutable_list_0, none_type_0)
...
def test_case_19():
    ...
    list_0 = []
    bool_0 = False
    immutable_list_0 = module_0.ImmutableList(list_0, none_type_0, bool_0)
    var_0 = immutable_list_0.to_list()
    immutable_list_0.reduce(var_0, list_0)
