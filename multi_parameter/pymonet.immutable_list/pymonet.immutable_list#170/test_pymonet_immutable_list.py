...
def test_case_8():
    ...
    var_0 = immutable_list_0.__len__()
    immutable_list_1 = module_0.ImmutableList(none_type_0, is_empty=bool_1)
    ...
    immutable_list_5 = immutable_list_0.__add__(immutable_list_1)
    bool_3 = immutable_list_4.__eq__(bool_0)
...
def test_case_12():
    ...
    immutable_list_4.reduce(bool_0, var_0)
