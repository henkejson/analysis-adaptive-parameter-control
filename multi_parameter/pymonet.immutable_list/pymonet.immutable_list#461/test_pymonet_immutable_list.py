...
def test_case_21():
    ...
    var_1 = immutable_list_0.find(bool_0)
    var_2 = immutable_list_0.reduce(bool_0, bool_1)
    immutable_list_1 = immutable_list_0.unshift(immutable_list_0)
