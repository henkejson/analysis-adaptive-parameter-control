...
def test_case_10():
    ...
    var_0 = immutable_list_1.reduce(dict_0, dict_0)
    var_1 = var_0.__len__()
    var_1.reduce(immutable_list_0, immutable_list_0)


def test_case_11():
    list_0 = []
    none_type_0 = None
    immutable_list_0 = module_0.ImmutableList(list_0, none_type_0, list_0)
    immutable_list_0.reduce(immutable_list_0, list_0)
