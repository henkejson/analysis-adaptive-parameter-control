...
def test_case_3():
    ...
    list_0 = [none_type_0, none_type_0, immutable_list_0, immutable_list_0]
...
def test_case_9():
    ...
    var_0 = immutable_list_0.reduce(immutable_list_2, immutable_list_1)
...
def test_case_22():
    ...
    var_5 = immutable_list_1.find(var_4)
    set_0 = set()
    immutable_list_2 = module_0.ImmutableList(immutable_list_0, var_2, set_0)
    immutable_list_2.reduce(var_3, var_1)
