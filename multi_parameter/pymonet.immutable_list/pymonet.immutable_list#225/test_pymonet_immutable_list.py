...
def test_case_13():
    ...
    str_0 = var_0.reduce(immutable_list_0, immutable_list_0)
...
def test_case_14():
    ...
    list_1 = []
    immutable_list_0 = module_0.ImmutableList(list_1, is_empty=list_1)
    immutable_list_1 = immutable_list_0.unshift(int_0)
    immutable_list_1.reduce(list_1, list_0)
