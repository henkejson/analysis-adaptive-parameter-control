...
def test_case_12():
    immutable_list_0 = module_0.ImmutableList()
    tuple_0 = immutable_list_0.find(immutable_list_0)
    immutable_list_0.filter(immutable_list_0)
...
def test_case_20():
    ...
    int_0 = -39
    none_type_0 = None
    bytes_0 = b"\xe1F\xeeTc\x84@m+\xdf;q\x13"
    immutable_list_0 = module_0.ImmutableList(none_type_0, is_empty=int_0)
    immutable_list_1 = immutable_list_0.unshift(bytes_0)
    immutable_list_1.reduce(int_0, float_0)
