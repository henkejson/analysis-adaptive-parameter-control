...
def test_case_14():
    ...
    immutable_list_1 = immutable_list_0.reduce(immutable_list_0, int_0)
    immutable_list_2 = immutable_list_0.unshift(int_0)
    immutable_list_2.find(int_0)


def test_case_15():
    bytes_0 = b"y4\xe2O\xc0\x89\x8c\xf0\xb4\x85\xdbMrX\x1b+"
    int_0 = -1245
    bool_0 = True
...
def test_case_20():
    ...
    str_0 = immutable_list_0.__str__()
    var_2 = var_0.to_list()
    immutable_list_1 = var_0.unshift(var_2)
    immutable_list_1.reduce(str_0, var_2)
