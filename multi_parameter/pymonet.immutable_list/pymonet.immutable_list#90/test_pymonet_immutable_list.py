...
def test_case_19():
    ...
    immutable_list_5 = immutable_list_1.unshift(immutable_list_1)
    immutable_list_6 = immutable_list_3.unshift(immutable_list_3)
    var_0 = immutable_list_3.reduce(none_type_0, none_type_0)
    var_1 = immutable_list_4.to_list()
    var_2 = immutable_list_4.find(var_0)
    immutable_list_5.reduce(var_0, immutable_list_0)


def test_case_20():
    none_type_0 = None
    bytes_0 = b"\x10/\xac\x1d\x1e\\\x10r\xec\xfe\xb5<\xd1\xc0"
