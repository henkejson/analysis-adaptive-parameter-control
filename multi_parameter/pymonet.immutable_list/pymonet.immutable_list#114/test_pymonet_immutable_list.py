...
def test_case_3():
    bytes_0 = b"\xc1\x03\xdb\xe2'O%D\x16~B3l\t\xab\xc0\x0c4\x1c"
    none_type_0 = None
...
def test_case_14():
    ...
    var_0 = module_0.ImmutableList(is_empty=bool_0)
    immutable_list_1 = module_0.ImmutableList(immutable_list_0, immutable_list_0)
    bool_1 = var_0.reduce(bool_0, var_0)
    var_1 = var_0.__len__()
...
def test_case_20():
    ...
    var_1 = immutable_list_2.append(var_0)
    var_1.map(bool_0)
