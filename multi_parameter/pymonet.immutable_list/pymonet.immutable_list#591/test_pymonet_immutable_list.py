...
def test_case_18():
    ...
    str_2 = immutable_list_0.reduce(str_0, none_type_0)
    ...
    immutable_list_2 = immutable_list_1.append(immutable_list_0)
    str_6 = immutable_list_1.__str__()
    immutable_list_3 = immutable_list_2.__add__(immutable_list_2)
    immutable_list_1.reduce(str_2, immutable_list_3)


def test_case_19():
    bytes_0 = b"\xf2\xe4\x99(\xf7\x80\xd2\xff\xa98"
    immutable_list_0 = module_0.ImmutableList()
