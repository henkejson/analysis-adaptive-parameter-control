...
def test_case_12():
    ...
    var_1 = var_0.__len__()
    var_0.reduce(var_0, immutable_list_0)
...
def test_case_20():
    ...
    var_2 = module_0.ImmutableList(immutable_list_1)
    var_3 = var_2.__len__()
    var_4 = immutable_list_0.reduce(var_3, var_2)
    bool_1 = immutable_list_0.__eq__(immutable_list_0)
    var_5 = immutable_list_2.find(var_4)
    bool_2 = immutable_list_0.__eq__(var_4)
