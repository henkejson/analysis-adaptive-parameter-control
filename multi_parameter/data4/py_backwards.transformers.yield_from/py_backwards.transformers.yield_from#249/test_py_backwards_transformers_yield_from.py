...
def test_case_2():
    ...
    yield_from_transformer_0 = module_0.YieldFromTransformer(aug_store_0)
    list_0 = [aug_store_0, yield_from_transformer_0, aug_store_0, aug_store_0]
...
def test_case_3():
    ...
    list_1 = [aug_store_0, yield_from_transformer_0, list_0]
