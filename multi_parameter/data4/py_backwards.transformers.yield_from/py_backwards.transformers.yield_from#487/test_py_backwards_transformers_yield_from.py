...
def test_case_0():
    ...
    a_s_t_0 = yield_from_transformer_0.visit(delete_0)
...
def test_case_2():
    floor_div_0 = module_0.FloorDiv()
    yield_from_transformer_0 = module_1.YieldFromTransformer(floor_div_0)
    list_0 = [floor_div_0, floor_div_0, floor_div_0, yield_from_transformer_0]
...
def test_case_3():
    floor_div_0 = module_0.FloorDiv()
    yield_from_transformer_0 = module_1.YieldFromTransformer(floor_div_0)
    var_0 = module_2.dump(floor_div_0, include_attributes=yield_from_transformer_0)
