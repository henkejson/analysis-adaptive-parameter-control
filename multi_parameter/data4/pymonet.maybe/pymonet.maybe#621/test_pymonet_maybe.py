...
def test_case_4():
    complex_0 = 2057.274484 - 2632.9934j
...
def test_case_19():
    ...
    var_3 = var_0.to_try()
    list_0 = [bool_0, maybe_0, var_3, maybe_1]
...
def test_case_21():
    ...
    var_4 = var_0.get_or_else(maybe_1)
    var_5 = var_3.to_lazy()
    var_6 = maybe_1.to_lazy()
    var_7 = var_3.to_try()
    var_8 = maybe_0.get_or_else(maybe_2)
    var_8.filter(var_5)
