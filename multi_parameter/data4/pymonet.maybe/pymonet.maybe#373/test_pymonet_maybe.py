...
def test_case_8():
    ...
    var_3 = var_2.ap(maybe_2)
    var_4 = var_3.bind(maybe_1)
    var_5 = var_3.map(bool_0)
...
def test_case_20():
    ...
    var_7 = var_2.to_try()
    var_8 = var_0.ap(var_0)
    var_9 = var_8.bind(var_0)
...
def test_case_22():
    ...
    var_7 = maybe_1.bind(tuple_0)
    var_8 = maybe_1.get_or_else(var_6)
    var_9 = maybe_1.to_box()
    bool_0 = var_7.__eq__(maybe_1)
    var_10 = var_1.to_try()
    bool_1 = maybe_0.__eq__(var_9)
    var_11 = var_8.bind(var_3)
    bool_2 = var_3.__eq__(var_10)
    var_12 = var_7.to_try()
    var_13 = var_7.get_or_else(var_6)
    var_3.ap(bool_1)
