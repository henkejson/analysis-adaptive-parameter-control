...
def test_case_8():
    ...
    immutable_list_3 = immutable_list_0.__add__(var_2)
    immutable_list_4 = var_0.__add__(immutable_list_0)
    bool_1 = var_0.__eq__(bool_0)
    bool_2 = immutable_list_0.__eq__(immutable_list_4)
    immutable_list_0.map(immutable_list_4)
...
def test_case_9():
    ...
    list_0 = [var_3, var_3, var_1, none_type_0]
    immutable_list_2 = var_0.unshift(list_0)
