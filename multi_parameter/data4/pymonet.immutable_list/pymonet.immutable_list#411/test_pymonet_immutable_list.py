...
def test_case_2():
    bytes_0 = b"s\xe3\xef#k\x04v\xf7\xee\x02\xffnT\x11\xec\x95"
    tuple_0 = (bytes_0,)
    tuple_1 = (tuple_0, bytes_0)
    immutable_list_0 = module_0.ImmutableList()
    immutable_list_0.__add__(tuple_1)
...
def test_case_7():
    ...
    var_2 = var_1.reduce(immutable_list_1, immutable_list_0)
    var_2.map(immutable_list_1)


def test_case_8():
    bytes_0 = b"\xd8\x04\xf2?\x03\xcb\xbcA\xa2\xb7\xb4\x0e\x8f\x8d\x9c\xb4\x1d"
    float_0 = -3093.7
...
def test_case_23():
    ...
    immutable_list_1.reduce(var_0, none_type_1)
