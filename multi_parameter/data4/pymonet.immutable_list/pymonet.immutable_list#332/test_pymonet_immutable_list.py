...
def test_case_17():
    ...
    var_2 = immutable_list_2.reduce(var_1, none_type_2)
    immutable_list_3 = module_0.ImmutableList(none_type_2)
    immutable_list_4 = immutable_list_2.unshift(immutable_list_2)
    var_3 = immutable_list_2.reduce(immutable_list_4, none_type_2)
    var_4 = immutable_list_3.reduce(var_3, immutable_list_3)
    immutable_list_4.reduce(var_4, immutable_list_3)
