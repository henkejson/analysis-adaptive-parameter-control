...
def test_case_8():
    ...
    var_3 = immutable_list_3.reduce(var_2, var_1)
...
def test_case_19():
    float_0 = 866.0
    float_1 = -2228.28727
    immutable_list_0 = module_0.ImmutableList(float_0, is_empty=float_1)
    str_0 = immutable_list_0.__str__()
    var_0 = immutable_list_0.__len__()
...
def test_case_20():
    float_0 = 866.0
    bytes_0 = b"\x8d\xaa1\xc6v\xd3\x84\x15\x06\xc5\xa6s\xe4,\x07\xb0\xf2\x8b8\xd9"
    none_type_0 = None
...
def test_case_21():
    ...
    immutable_list_5.reduce(var_2, var_1)
