...
def test_case_8():
    bytes_0 = b'\x9fO^\x13H\xd3\x1d\xa3V"\xafm#\xd8\xbc\rB7w\xfc'
    none_type_0 = None
    immutable_list_0 = module_0.ImmutableList()
    var_0 = immutable_list_0.reduce(bytes_0, none_type_0)
    str_0 = var_0.__str__()
    none_type_1 = None
    ...
    immutable_list_4 = immutable_list_3.append(none_type_1)
...
def test_case_13():
    bytes_0 = b"n)F\xd0\xed\xc2,\xe0\xc7k\xa9@"
    none_type_0 = None
...
def test_case_21():
    ...
    immutable_list_1.reduce(immutable_list_3, var_1)
