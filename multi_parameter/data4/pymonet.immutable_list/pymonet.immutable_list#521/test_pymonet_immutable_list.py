...
def test_case_11():
    ...
    var_1 = immutable_list_0.reduce(immutable_list_2, var_0)
...
def test_case_22():
    ...
    immutable_list_2 = module_0.ImmutableList(immutable_list_1, var_1)
    immutable_list_2.reduce(var_1, immutable_list_1)
