...
def test_case_12():
    complex_0 = 5725.4 + 190.38j
    none_type_0 = None
    immutable_list_0 = module_0.ImmutableList(complex_0, none_type_0, none_type_0)
...
def test_case_19():
    ...
    none_type_0 = None
    immutable_list_3 = module_0.ImmutableList(none_type_0, int_0)
    var_0 = immutable_list_3.find(immutable_list_2)
    var_1 = immutable_list_2.unshift(var_0)
    var_1.map(bool_0)
