...
def test_case_6():
    bytes_0 = b"\xe4\xa9G\x07'V\x8c\xa3\xa4\x1e\xf4\xc5\xe9"
...
def test_case_7():
    complex_0 = -666.0489 + 3376.018281j
    bool_0 = True
...
def test_case_14():
    ...
    none_type_1 = None
    immutable_list_0.reduce(immutable_list_1, none_type_1)
...
def test_case_18():
    ...
    immutable_list_3 = var_0.unshift(bool_0)
    var_1 = immutable_list_0.reduce(var_0, immutable_list_3)
    bool_1 = True
    var_1.reduce(var_1, bool_1)
