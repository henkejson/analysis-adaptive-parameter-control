...
def test_case_2():
    ...
    yield_from_transformer_0 = module_0.YieldFromTransformer(assign_0)
    list_0 = [
...
def test_case_3():
    ...
    yield_from_transformer_0.visit(function_def_0)
...
def test_case_4():
    ...
    a_s_t_1 = yield_from_transformer_0.visit(function_def_0)
