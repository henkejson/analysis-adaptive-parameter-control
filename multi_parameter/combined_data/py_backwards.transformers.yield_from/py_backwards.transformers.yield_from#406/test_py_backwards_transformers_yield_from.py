...
def test_case_3():
    str_0 = "s"
    interactive_0 = module_2.Interactive(*str_0)
    yield_from_transformer_0 = module_0.YieldFromTransformer(interactive_0)
    yield_from_transformer_1 = module_0.YieldFromTransformer(interactive_0)
    a_s_t_0 = yield_from_transformer_1.visit(interactive_0)
    yield_from_transformer_2 = module_0.YieldFromTransformer(a_s_t_0)
    yield_from_transformer_3 = module_0.YieldFromTransformer(interactive_0)
    yield_from_transformer_4 = module_0.YieldFromTransformer(interactive_0)
    a_s_t_1 = yield_from_transformer_1.visit(interactive_0)
