...
def test_case_25():
    ...
    bool_2 = maybe_0.__eq__(maybe_0)
    maybe_2 = module_0.Maybe(none_type_0, bool_0)
    maybe_3 = maybe_0.to_lazy()
    var_0 = maybe_0.to_box()
    var_1 = maybe_2.map(maybe_3)
