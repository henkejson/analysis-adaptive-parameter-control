...
def test_case_3():
    ...
    var_5 = module_0.Maybe(maybe_0, bool_0)
...
def test_case_16():
    ...
    maybe_0 = module_0.Maybe(str_1, set_0)
    ...
    maybe_2 = module_0.Maybe(str_1, maybe_1)
    maybe_1.map(maybe_2)
...
def test_case_20():
    ...
    var_9 = var_3.filter(maybe_1)
    var_10 = var_7.ap(none_type_0)
    var_11 = var_7.to_box()
    bool_3 = var_7.__eq__(str_0)
    var_12 = var_3.to_box()
    bool_0.filter(var_12)
