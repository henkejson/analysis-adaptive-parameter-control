...
def test_case_12():
    bytes_0 = b"\xbe\xd8\xab\x07\xc6\x90\xbaI\xd9pK\xe3\xfb\xaf'"
    none_type_0 = None
...
def test_case_25():
    ...
    var_4 = var_0.to_lazy()
    var_5 = var_2.get_or_else(list_0)
    var_6 = var_0.to_box()
    var_7 = var_3.to_box()
    ...
    maybe_3 = module_0.Maybe(var_11, var_5)
    var_12 = var_11.ap(var_4)
    var_13 = maybe_0.map(var_2)
    var_5.to_validation()
