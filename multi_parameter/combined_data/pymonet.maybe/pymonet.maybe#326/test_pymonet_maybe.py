...
def test_case_7():
    bytes_0 = b"\xe8\x1a\xb2\x04\x04K.\xb5u\xbdS\x0f\x8d\xfb."
    none_type_0 = None
    bool_0 = False
...
def test_case_16():
    ...
    maybe_0 = module_0.Maybe(bool_0, bool_1)
    object_0 = module_1.object()
    bool_2 = maybe_0.get_or_else(maybe_0)
    var_0 = maybe_0.to_try()
    maybe_0.filter(var_0)
...
def test_case_18():
    bytes_0 = b"\xd3H\x8f\xb9\xbd\x13\xddC\x0e:a^\xefv\t"
    none_type_0 = None
    bool_0 = False
    maybe_0 = module_0.Maybe(none_type_0, bool_0)
    var_0 = maybe_0.to_validation()
