...
def test_case_12():
    float_0 = -1149.0
    bytes_0 = b"'e\xc6\x01}\xbf*2^\x83\r\xc6\x13?"
...
def test_case_20():
    ...
    bytes_0 = b"B)8\xb0\x89rJ\xc0\xb1\xcdALL\x07,\xd7\xf78&"
    var_3 = maybe_2.to_try()
    maybe_3 = module_0.Maybe(bytes_0, int_0)
    var_4 = maybe_3.get_or_else(dict_0)
    dict_0.filter(dict_0)
