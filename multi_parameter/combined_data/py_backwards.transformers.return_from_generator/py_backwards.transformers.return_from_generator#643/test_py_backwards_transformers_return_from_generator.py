...
def test_case_1():
    str_0 = "~fcr"
    async_function_def_0 = module_1.AsyncFunctionDef(*str_0)
    return_from_generator_transformer_0 = module_0.ReturnFromGeneratorTransformer(str_0)
    function_def_0 = return_from_generator_transformer_0.visit_FunctionDef(
...
def test_case_2():
    str_0 = "~fcr"
    async_function_def_0 = module_2.parse(str_0, str_0)
    return_from_generator_transformer_0 = module_0.ReturnFromGeneratorTransformer(str_0)
    function_def_0 = return_from_generator_transformer_0.visit_FunctionDef(
        async_function_def_0
    )
