...
def test_case_2():
    ...
    var_1 = module_2.iter_fields(function_def_0)
    var_2 = module_2.increment_lineno(var_0)
    var_1.visit_FunctionDef(var_0)
...
def test_case_3():
    ...
    var_2 = return_from_generator_transformer_1.generic_visit(function_def_0)
    var_2.visit_FunctionDef(var_2)
