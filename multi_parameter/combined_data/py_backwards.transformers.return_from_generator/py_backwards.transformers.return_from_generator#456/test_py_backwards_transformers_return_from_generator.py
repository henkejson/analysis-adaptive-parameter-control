...
def test_case_3():
    ...
    var_0 = return_from_generator_transformer_0.generic_visit(function_def_1)
    if_exp_0 = return_from_generator_transformer_1.generic_visit(var_0)
    module_2.fix_missing_locations(list_0)
