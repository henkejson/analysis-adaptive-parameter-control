...
def test_case_1():
    ...
    list_0 = [assign_0, base_import_rewrite_0, base_import_rewrite_0]
...
def test_case_2():
    ...
    list_0 = [assign_0, var_0, base_import_rewrite_0]
    import_from_0 = module_1.ImportFrom(*list_0)
...
def test_case_3():
    assign_0 = module_1.Assign()
    base_import_rewrite_0 = module_0.BaseImportRewrite(assign_0)
    var_0 = module_2.iter_child_nodes(assign_0)
    list_0 = [assign_0, var_0, var_0]
    import_from_0 = module_1.ImportFrom(*list_0)
