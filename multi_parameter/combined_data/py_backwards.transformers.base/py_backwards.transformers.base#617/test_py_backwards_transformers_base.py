...
def test_case_2():
    ...
    list_0 = [none_type_0, none_type_0, arguments_0]
    import_from_0 = module_0.ImportFrom(*list_0)
...
def test_case_3():
    arguments_0 = module_0.arguments()
    base_import_rewrite_0 = module_2.iter_child_nodes(arguments_0)
    list_0 = [base_import_rewrite_0, base_import_rewrite_0, arguments_0]
    base_import_rewrite_1 = module_1.BaseImportRewrite(arguments_0)
    import_from_0 = module_0.ImportFrom(*list_0)
