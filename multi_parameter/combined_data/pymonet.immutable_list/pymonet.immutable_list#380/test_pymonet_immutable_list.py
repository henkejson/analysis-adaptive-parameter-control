...
def test_case_12():
    ...
    immutable_list_2 = var_0.append(bool_0)
    str_1 = var_1.__str__()
    immutable_list_3 = module_0.ImmutableList()
    var_2 = immutable_list_3.find(var_1)
    str_2 = var_0.__str__()
    immutable_list_4 = var_1.__add__(var_0)
...
def test_case_21():
    ...
    var_2 = immutable_list_0.find(var_1)
    var_3 = immutable_list_0.reduce(var_2, bool_2)
    var_4 = immutable_list_0.__len__()
    var_5 = immutable_list_0.reduce(var_4, immutable_list_0)
