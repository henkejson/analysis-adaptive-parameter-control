...
def test_case_8():
    ...
    none_type_1 = None
    immutable_list_1 = module_0.ImmutableList(none_type_1, immutable_list_0)
    var_2 = immutable_list_1.reduce(immutable_list_0, none_type_0)
...
def test_case_9():
    ...
    var_1 = immutable_list_1.reduce(bool_1, immutable_list_1)
    immutable_list_3 = module_0.ImmutableList(tail=immutable_list_0, is_empty=bool_1)
