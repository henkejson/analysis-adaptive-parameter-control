...
def test_case_10():
    ...
    immutable_list_4 = module_0.ImmutableList(tail=str_0)
    var_1 = immutable_list_2.find(str_0)
...
def test_case_13():
    ...
    bytes_0 = b".\x1dl\xb3J\xae\x8c"
    immutable_list_1 = module_0.ImmutableList()
    var_0 = immutable_list_1.reduce(bytes_0, bytes_0)
    var_1 = var_0.__len__()
    str_0 = "@{(c<>-VFq"
    var_2 = immutable_list_0.reduce(immutable_list_0, none_type_0)
    immutable_list_2 = module_0.ImmutableList(str_0, str_0)
    immutable_list_2.reduce(var_1, var_0)
