...
def test_case_2():
    ...
    none_type_1 = None
    bool_0 = False
    immutable_list_0 = module_0.ImmutableList(list_0, none_type_1, bool_0)
    immutable_list_0.__add__(none_type_0)


def test_case_3():
    complex_0 = 2615.18 - 2205.8j
...
def test_case_12():
    ...
    var_2 = immutable_list_1.reduce(immutable_list_0, var_1)
    immutable_list_2 = immutable_list_0.unshift(immutable_list_0)


def test_case_13():
    str_0 = "{W"
    bytes_0 = b"\xe9\xfc?'\x82\xc7\xfd\xb7l\x93\nA[\xfe\xb3"
    immutable_list_0 = module_0.ImmutableList()
...
def test_case_18():
    ...
    immutable_list_0.reduce(float_0, bytes_0)
