...
def test_case_14():
    ...
    bool_2 = True
    none_type_1 = None
    immutable_list_0 = module_0.ImmutableList(bool_2, none_type_1)
    immutable_list_1 = immutable_list_0.append(none_type_0)
    immutable_list_1.reduce(bool_0, bool_1)
