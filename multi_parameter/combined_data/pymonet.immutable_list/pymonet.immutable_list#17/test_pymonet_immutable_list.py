...
def test_case_15():
    ...
    bool_0 = immutable_list_0.find(var_1)
    none_type_0 = None
...
def test_case_20():
    ...
    immutable_list_5 = immutable_list_3.unshift(immutable_list_2)
    immutable_list_5.filter(none_type_1)
