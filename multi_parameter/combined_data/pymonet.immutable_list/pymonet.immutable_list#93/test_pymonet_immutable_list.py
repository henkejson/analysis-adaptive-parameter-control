...
def test_case_8():
    ...
    immutable_list_4 = module_0.ImmutableList(none_type_1, none_type_1)
    var_2 = immutable_list_3.__len__()
    var_3 = immutable_list_4.find(none_type_0)
    var_4 = immutable_list_0.to_list()
    none_type_2 = None
    bool_1 = True
    none_type_3 = None
    immutable_list_5 = module_0.ImmutableList()
    immutable_list_6 = immutable_list_5.append(none_type_3)
    immutable_list_7 = immutable_list_6.unshift(bool_1)
    immutable_list_7.map(none_type_2)
