...
def test_case_0():
    str_0 = ";O'A_C\x0bEk_oXr\x0cf z{q["
    tuple_0 = (str_0,)
...
def test_case_15():
    complex_0 = -46.41287 - 24j
    immutable_list_0 = module_0.ImmutableList()
    immutable_list_1 = module_0.ImmutableList(complex_0)
    bool_0 = True
    immutable_list_2 = module_0.ImmutableList()
    immutable_list_3 = immutable_list_2.unshift(bool_0)
    var_0 = immutable_list_0.reduce(immutable_list_0, immutable_list_3)
    immutable_list_4 = immutable_list_1.append(complex_0)
    bool_1 = immutable_list_1.__eq__(immutable_list_4)
    immutable_list_5 = immutable_list_2.unshift(immutable_list_3)
    var_1 = immutable_list_4.to_list()
    var_2 = immutable_list_5.to_list()
    var_0.reduce(var_1, var_0)
