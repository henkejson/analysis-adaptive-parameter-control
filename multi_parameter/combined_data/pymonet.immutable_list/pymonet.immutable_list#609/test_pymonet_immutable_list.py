...
def test_case_13():
    ...
    immutable_list_3 = module_0.ImmutableList(var_0, immutable_list_0)
    immutable_list_3.reduce(immutable_list_3, var_1)
...
def test_case_20():
    ...
    immutable_list_1.reduce(immutable_list_0, float_0)
