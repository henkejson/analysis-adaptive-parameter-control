...
def test_case_1():
    ...
    list_0 = [base_import_rewrite_0, list_comp_0, list_comp_0]
...
def test_case_3():
    ...
    base_import_rewrite_0 = module_1.BaseImportRewrite(list_comp_0)
    list_0 = [base_import_rewrite_0, list_comp_0, list_comp_0]
    list_1 = [list_comp_0, list_0, base_import_rewrite_0]
...
def test_case_4():
    list_comp_0 = module_0.ListComp()
    base_import_rewrite_0 = module_1.BaseImportRewrite(list_comp_0)
    var_0 = module_2.iter_fields(list_comp_0)
    list_0 = [list_comp_0, var_0, base_import_rewrite_0]
    import_from_0 = module_0.ImportFrom(*list_0)
