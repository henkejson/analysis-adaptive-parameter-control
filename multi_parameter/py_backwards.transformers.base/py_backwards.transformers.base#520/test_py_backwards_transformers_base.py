...
def test_case_1():
    ...
    base_import_rewrite_0 = module_0.BaseImportRewrite(param_0)
    list_0 = [base_import_rewrite_0, param_0]
...
def test_case_4():
    param_0 = module_1.Param()
    base_import_rewrite_0 = module_0.BaseImportRewrite(param_0)
    var_0 = module_2.iter_child_nodes(param_0)
    list_0 = [param_0, var_0]
    import_from_0 = module_1.ImportFrom(*list_0)
