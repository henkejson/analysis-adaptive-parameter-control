...
def test_case_2():
    ...
    base_node_transformer_1 = module_0.BaseImportRewrite(none_type_0)
    base_import_rewrite_1 = module_0.BaseImportRewrite(function_type_0)
    list_0 = [none_type_0, base_import_rewrite_0, yield_0]
    import_from_0 = module_1.ImportFrom(*list_0)
    base_import_rewrite_0.visit_ImportFrom(import_from_0)
