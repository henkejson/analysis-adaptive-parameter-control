...
def test_case_3():
    ...
    list_0 = [converter_plugin_0, none_type_0, converter_plugin_0, converter_plugin_0]
    list_1 = [list_0, none_type_0, none_type_0, converter_plugin_0]
    module_0.BasePlugin(*list_1)
